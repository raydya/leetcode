...
public class MaximumDifferenceBetweenIncreasingElementsTest {
    ...
    @Test
    public void test1() {
        final MaximumDifferenceBetweenIncreasingElements solution = new MaximumDifferenceBetweenIncreasingElements();
        final int output = solution.maximumDifference(new int[]{7, 1, 5, 4});
    ...
    public void test2() {
        final MaximumDifferenceBetweenIncreasingElements solution = new MaximumDifferenceBetweenIncreasingElements();
        final int output = solution.maximumDifference(new int[]{9, 4, 3, 2});
    ...
    public void test3() {
        final MaximumDifferenceBetweenIncreasingElements solution = new MaximumDifferenceBetweenIncreasingElements();
        final int output = solution.maximumDifference(new int[]{1, 5, 2, 10});
    ...
    public void test4() {
        final MaximumDifferenceBetweenIncreasingElements solution = new MaximumDifferenceBetweenIncreasingElements();
        final int output = solution.maximumDifference(new int[]{
            999, 997, 980, 976, 948, 940, 938, 928, 924, 917, 907, 907, 881, 878, 864, 862, 859, 857, 848, 840, 824,
