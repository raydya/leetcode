...
public class FindAllNumberDisappearedInAnArrayTest {
    ...
    public void test1() {
        ...
        final List<Integer> disappearedNumbers = solution.findDisappearedNumbers(new int[]{4, 3, 2, 7, 8, 2, 3, 1});
    ...
    public void test3() {
        ...
        Assert.assertArrayEquals(Collections.singletonList(2).toArray(), disappearedNumbers.toArray());
    }

    @Test
    public void test4() {
        final FindAllNumbersDisappearedInAnArray solution = new FindAllNumbersDisappearedInAnArray();
        final List<Integer> disappearedNumbers = solution.findDisappearedNumbers(new int[]{1, 1, 2, 2});
    ...
    public void test5() {
        final FindAllNumbersDisappearedInAnArray solution = new FindAllNumbersDisappearedInAnArray();
        final List<Integer> disappearedNumbers = solution.findDisappearedNumbers(new int[]{5, 4, 6, 7, 9, 3, 10, 9, 5, 6});
