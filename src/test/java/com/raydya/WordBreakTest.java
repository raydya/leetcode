...
public class WordBreakTest {
    ...
    public void test1() {
        ...
        final boolean output = solution.wordBreak("leetcode", Arrays.asList("leet", "code"));
    ...
    public void test2() {
        final WordBreak solution = new WordBreak();
        final boolean output = solution.wordBreak("applepenapple", Arrays.asList("apple", "pen"));
    ...
    public void test3() {
        final WordBreak solution = new WordBreak();
        final boolean output = solution.wordBreak("catsandog",
    ...
    public void test4() {
        final WordBreak solution = new WordBreak();
        final boolean output = solution.wordBreak("cars", Arrays.asList("car", "ca", "rs"));
    ...
    public void test5() {
        final WordBreak solution = new WordBreak();
        final boolean output = solution.wordBreak("cbca", Arrays.asList("bc", "ca"));
    ...
    public void test6() {
        final WordBreak solution = new WordBreak();
        final boolean output = solution.wordBreak("ccaccc", Arrays.asList("cc", "ac"));
    ...
    public void test7() {
        final WordBreak solution = new WordBreak();
        final boolean output = solution.wordBreak("aaaaaaa", Arrays.asList("aaaa", "aaa"));
    ...
    public void test8() {
        final WordBreak solution = new WordBreak();
        final boolean output = solution.wordBreak("fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami",
            Arrays.asList("kfomka", "hecagbngambii", "anobmnikj", "c", "nnkmfelneemfgcl", "ah",
                ...
                "jjiadlgf", "ogadjhambjikce", "bglghjndlk", "gackokkbhj", "oofohdogb", "leiolllnjj",
                "edekdnibja", "gjhglilocif", "ccfnfjalchc", "gl", "ihee", "cfgccdmecem",
                "mdmcdgjelhgk", "laboglchdhbk", "ajmiim", "cebhalkngloae", "hgohednmkahdi",
                ...
                "jddfkfbbbhia", "cddmfeckheeo", "bfnmaalmjdb", "fbcg", "ko", "mojfj", "kk",
                ...
                "nccjbnldneijc", "hgiccigeehmdl", "dlfmjhmioa", "kmff", "gfhkd", "okiamg",
                "ekdbamm", "fc", "neg", "cfmo", "ccgahikbbl", "khhoc", "elbg", "cbghbacjbfm",
                "jkagbmfgemjfg", "ijceidhhajmja", "imibemhdg", "ja", "idkfd", "ndogdkjjkf", "fhic",
                "ooajkki", "fdnjhh", "ba", "jdlnidngkfffbmi", "jddjfnnjoidcnm", "kghljjikbacd",
                "idllbbn", "d", "mgkajbnjedeiee", "fbllleanknmoomb", "lom", "kofjmmjm",
                "mcdlbglonin", "gcnboanh", "fggii", "fdkbmic", "bbiln", "cdjcjhonjgiagkb",
                "kooenbeoongcle", "cecnlfbaanckdkj", "fejlmog", "fanekdneoaammb", "maojbcegdamn",
                "bcmanmjdeabdo", "amloj", "adgoej", "jh", "fhf", "cogdljlgek", "o", "joeiajlioggj",
                "oncal", "lbgg", "elainnbffk", "hbdi", "femcanllndoh", "ke", "hmib", "nagfahhljh",
