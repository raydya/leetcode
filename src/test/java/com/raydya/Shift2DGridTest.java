...
public class Shift2DGridTest {
    ...
    public void test1() {
        ...
        final List<List<Integer>> output = solution.shiftGrid(
    ...
    public void test2() {
        ...
        Assert.assertArrayEquals(new Integer[]{12, 0, 21, 13},
            output.get(0).toArray(new Integer[]{}));
        Assert.assertArrayEquals(new Integer[]{3, 8, 1, 9}, output.get(1).toArray(new Integer[]{}));
        Assert.assertArrayEquals(new Integer[]{19, 7, 2, 5},
            output.get(2).toArray(new Integer[]{}));
        Assert.assertArrayEquals(new Integer[]{4, 6, 11, 10},
            output.get(3).toArray(new Integer[]{}));
    }
