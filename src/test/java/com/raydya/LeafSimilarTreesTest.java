...
public class LeafSimilarTreesTest {
    @Test
    public void test1() {
        final TreeNode root1 = TreeNodeUtil.build(Arrays.asList(3, 5, 1, 6, 2, 9, 8, null, null, 7, 4));
        final TreeNode root2 = TreeNodeUtil.build(Arrays.asList(3, 5, 1, 6, 7, 4, 2, null, null, null, null, null, null, 9, 8));
