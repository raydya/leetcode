...
public class CheckIfEveryRowAndColumnContainsAllNumbersTest {
    ...
    @Test
    public void test1() {
        final CheckIfEveryRowAndColumnContainsAllNumbers solution = new CheckIfEveryRowAndColumnContainsAllNumbers();
        final boolean output = solution.checkValid(new int[][]{
            {1, 2, 3},
            {3, 1, 2},
            {2, 3, 1}
        });
