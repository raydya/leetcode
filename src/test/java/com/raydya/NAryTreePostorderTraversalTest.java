...
public class NAryTreePostorderTraversalTest {
    ...
    public void test1() {
        ...
        final NAryTreePostorderTraversal.Node n1 = new NAryTreePostorderTraversal.Node(3,
            Arrays.asList(n4, n5));

        final NAryTreePostorderTraversal.Node root = new NAryTreePostorderTraversal.Node(1,
    ...
    public void test2() {
        ...
        final NAryTreePostorderTraversal.Node n10 = new NAryTreePostorderTraversal.Node(11,
            Collections.singletonList(n13));

        final NAryTreePostorderTraversal.Node n9 = new NAryTreePostorderTraversal.Node(10);
        final NAryTreePostorderTraversal.Node n8 = new NAryTreePostorderTraversal.Node(9,
            Collections.singletonList(n12));
        final NAryTreePostorderTraversal.Node n7 = new NAryTreePostorderTraversal.Node(8,
            Collections.singletonList(n11));
        final NAryTreePostorderTraversal.Node n6 = new NAryTreePostorderTraversal.Node(7,
        ...
        final NAryTreePostorderTraversal.Node n2 = new NAryTreePostorderTraversal.Node(3,
            Arrays.asList(n5, n6));
        ...
        Assert.assertArrayEquals(new Integer[]{2, 6, 14, 11, 7, 3, 12, 8, 4, 13, 9, 10, 5, 1},
            output.toArray());
    }
}
