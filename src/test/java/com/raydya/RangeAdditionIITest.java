...
public class RangeAdditionIITest {
    ...
    public void test3() {
        ...
        final int output = solution.maxCount(18, 3, new int[][]{
            {16, 1}, {14, 3}, {14, 2}, {4, 1}, {10, 1}, {11, 1}, {8, 3}, {16, 2}, {13, 1}, {8, 3},
            {2, 2}, {9, 1}, {3, 1}, {2, 2}, {6, 3}
        });
    ...
    public void test5() {
        final RangeAdditionII solution = new RangeAdditionII();
        final int output = solution.maxCount(26797, 12287,
            new int[][]{{18717, 11856}, {3154, 2135}, {561, 10977}, {14679, 3527}, {17166, 1028},
